...
import com.example.foodOrder.dto.request.LoginRequest;
import com.example.foodOrder.dto.response.AuthResponse;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> createUserHandler(@RequestBody Users user) throws Exception {
        ...
        if(isEmailExist != null){
            throw new Exception("Email is already use with anothe account");
        }
